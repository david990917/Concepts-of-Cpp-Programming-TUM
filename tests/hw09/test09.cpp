...
TEST_CASE_TEMPLATE("Default Constructor", T, bool, char, short, int, long long int, float, double,
                   std::string)
{
    Vector<T> v = Vector<T>();
    CHECK_EQ(v.size(), 0);
...
TEST_CASE("String Constructor with default value")
{
    ...
    for (auto i{0}; i < v.size(); ++i) CHECK_EQ(v[i], defaultValue);
    for (auto i{0}; i < v.size(); ++i) CHECK_EQ(v.at(i), defaultValue);
    REQUIRE_THROWS_AS(v.at(v.size()), const std::out_of_range&);
}
...
TEST_CASE("String Copy Constructor")
{
    ...
    for (auto i{0}; i < v.size(); ++i) CHECK_EQ(v[i], w[i]);
    v[0] = "New Value!";
    CHECK_NE(v[0], w[0]);
...
TEST_CASE("String Move Constructor")
{
    ...
    for (auto i{0}; i < w.size(); ++i) CHECK_EQ(w[i], defaultValue);
}
...
TEST_CASE_TEMPLATE("Copy Constructor", T, bool, char, short, int, long long int, float, double)
{
    int       count = 10;
    T         defaultValue{1};
...
TEST_CASE_TEMPLATE("Copy Assignment", T, char, short, int, long long int, float, double)
{
    int       count = 10;
    T         defaultValue{1};
    Vector<T> v = Vector<T>(count, defaultValue);
...
TEST_CASE_TEMPLATE("Move Constructor", T, bool, char, short, int, long long int, float, double)
{
    int       count = 10;
    T         defaultValue{1};
    Vector<T> v        = Vector<T>(count, defaultValue);
...
TEST_CASE_TEMPLATE("Move Assignment", T, char, short, int, long long int, float, double)
{
    int       count = 10;
    T         defaultValue{1};
    Vector<T> v        = Vector<T>(count, defaultValue);
...
TEST_CASE_TEMPLATE("Constructor with default value", T, bool, char, short, int, long long int,
                   float, double)
{
    int       count = 10;
    T         defaultValue{1};
...
TEST_CASE_TEMPLATE("push_back", T, bool, char, short, int, long long int, float, double)
{
    Vector<T> v = Vector<T>();
    CHECK_EQ(v.size(), 0);
...
TEST_CASE_TEMPLATE("pop_back", T, bool, char, short, int, long long int, float, double)
{
    size_t    count = 32;
