...
public:
     ...
     */
    bool register_file(const std::string& name, const std::shared_ptr<File>& file);
     ...
     */
    std::vector<std::shared_ptr<File>> files_in_size_range(size_t max, size_t min = 0) const;
